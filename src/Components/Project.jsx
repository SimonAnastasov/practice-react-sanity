    ...
    return (
        <main className="bg-green-100 min-h-screen p-12">
            <section className="container mx-auto">
                ...
                <h2 className="text-lg text-gray-600 flex justify-center mb-12">Welcome to my projects gospodine</h2>
                <section className="grid grid-cols-2 gap-8">
                    {projectData && projectData.map((project, index) => (
                        <article className="relative rounded-lg shadow-xl bg-white p-16" key={project.title}>
